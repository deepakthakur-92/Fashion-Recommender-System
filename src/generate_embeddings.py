...
class Embeddings:
    ...
    """
            This class shall be used for generate the embedding for all the images
    ...
    def extract_features(img_path, model):
        """
                ...
                Description: This method extract all the feature for the given image

                Output: normalized result of an image
    ...
    def create_model():
        """
                ...
                Description: This method creates the resnet model on imagenet data
        ...
        model = ResNet50(weights=weights,include_top=include_tops, input_shape=(224,224,3))
